...
class Destinations extends StatefulWidget {
  String? subscribe;
  Destinations({Key? key, this.subscribe}) : super(key: key);
...
class _DestinationsState extends State<Destinations>
  ...
  void initState() {
    ...
    initLifeCycler();
    print("oldLanguageCode --> $oldLanguageCode");
    init();
    super.initState();
  }
  ...
  Future<void> didChangeAppLifecycleState(AppLifecycleState state) async {
    ...
    if (state == AppLifecycleState.resumed) {
      ...
      print("oldLanguageCode  $oldLanguageCode --> languageCode $languageCode");
      ...
      if (isConnect == ConnectivityResult.mobile) {
        WidgetsBinding.instance.addPostFrameCallback((_) async {
          SubscriptionResponseModel model =
              await CallService().getSubscriptionList();
          setState(() {
                                                                  ...
                                                                  if (selectedDestinations!
                                                                    ...
                                                                    Countries selectedCountry = Countries(
                                                                        ...
                                                                        selectedContinentId:
                                                                            countryList[index]
                                                                                .id!,
                                                                        countryImage: countryList[index]
                                                                            .countries![idx]
                                                                            .countryImage);
                                                                    this.setState(
                                                                        () {
                                                                            ...
                                                                            onChanged:
                                                                              ...
                                                                              if (countryList[index].countries![idx].selected) {
                                                                                ...
                                                                                if (selectedDestinations!.length < 4) {
                                                                                  ...
                                                                                  Countries selectedCountry = Countries(id: countryList[index].countries![idx].id, destId: countryList[index].countries![idx].destId, selectedCityIndex: ind, selected: true, selectedCityId: countryList[index].countries![idx].cities![countryList[index].countries![idx].selectedCityIndex].id!, countryName: countryList[index].countries![idx].cities![countryList[index].countries![idx].selectedCityIndex].cityName, selectedContinentId: countryList[index].id!, countryImage: countryList[index].countries![idx].countryImage);
                                                                                  this.setState(() {
                                                                                    selectedDestinations?.add(selectedCountry);
                                                                                  });
                                                                                }
                                                                              }
                                                                              Get.back();
