...
class ReadMoreText extends StatefulWidget {
  ...
  final String data;
  final TextStyle? trimExpandedTextStyle;
...
class ReadMoreTextState extends State<ReadMoreText> {
  ...
  Widget build(BuildContext context) {
    ...
    TextSpan link = TextSpan(
        text: widget.readMore == false
            ? widget.trimCollapsedText
            : widget.trimExpandedText,
        style: widget.trimExpandedTextStyle ?? TextStyle(),
        //style: widget.readMore ? _defaultMoreStyle : _defaultLessStyle,
        //style: TextStyle(fontWeight: FontWeight.bold,fontSize: Get.height*0.018),
    ...
    Widget result = LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        ...
        if (linkSize.width < maxWidth) {
          ...
          endIndex = textPainter.getOffsetBefore(pos.offset - 2) ?? 0;
        } else {
          var pos = textPainter.getPositionForOffset(
            textSize.bottomLeft(Offset.zero),
          );
          endIndex = pos.offset - 2;
